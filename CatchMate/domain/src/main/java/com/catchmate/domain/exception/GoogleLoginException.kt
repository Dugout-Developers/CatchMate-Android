...
sealed class GoogleLoginException(message: String) : Exception(message) {
    ...
    data class Unknown(val originalException: Throwable) : GoogleLoginException("알 수 없는 오류가 발생했습니다.")
}
